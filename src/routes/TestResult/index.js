      ...
      <div className="App">
        ...
        <div className="App-partioner">
          <Chart
            chartType="Bar"
            data={passResults}
            title="Test Case Pass Percentage"
          />
          <Chart
            width="600px"
            height="400px"
        ...
        <div className="App-partioner">
          <ResultTable
            data={featureResults}
            title="Test Case Count - Per Execution and Feature"
          />
          <ResultTable
            data={totalRecordsWithPercent}
            title="Test Case Count - Per Execution"
          />
        </div>
        <div className="App-partioner">
          <ResultTable
            data={testPlanResults}
            title="Test Case Count - Per Execution, Feature and Testplan"
          />
          <ResultTable
            data={testCaseResults}
            title="Test Case - Execution, Feature, Testplan"
          />
        </div>
      </div>
    ) : (
      <h2>Please connect to node server to get test results</h2>
    )
  }
}
